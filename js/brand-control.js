...
require(['jquery','vizjs_toolkit/core/visualizeHelper'], function($,VisualizeHelper) {	
	...
	$(window).load(function() {
		preloadImagesForTooltip();			
	});
	
	$('.resetControls').on('click', function(e) {
		resetControls();
		e.preventDefault();
	});	

	$('.showTopTen').on('click', function(e) {
		topTen();
		e.preventDefault();
	});	
	...
	*/
	...
	function initializeReports(v) {
		...
		masterReport = renderReportLink(master, '#brands', v);
		slaveReport = renderReport(slave, '#products', v);
	}
	...
	function preloadImagesForTooltip(){
		preload([
			...
			'img/products/thumbnails/Hermanos Corn on the Cob.jpg',
			...
			'img/products/thumbnails/Tell Tale Corn on the Cob.jpg',
			...
			'img/products/thumbnails/Ebony Corn on the Cob.jpg',
			...
			'img/products/thumbnails/Tri-State Corn on the Cob.jpg',
			...
			'img/products/thumbnails/High Top Corn on the Cob.jpg',
